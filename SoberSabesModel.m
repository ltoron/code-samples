...
% won't do in MatLab for now, use Jupyter notebook for this
...
%          propShift = IntSlider(min=-7, max=+7, step=1, value=6),
%          angleShift = IntSlider(min=0, max= 345, step = 15, value = 0),
